...
public class BaseSelenium {
	...
	private static String url = "https://www.grocerycrud.com/v1.x/demo/bootstrap_theme";
	...
	public void duploClick(By elemento) {
		...
		act.doubleClick((WebElement) elemento).perform();
	}
	...
	public void comparaTextoDoElemento(By object, String texto) {
		assertEquals(object, texto);
	}
